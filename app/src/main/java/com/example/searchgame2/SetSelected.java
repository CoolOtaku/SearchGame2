...
public class SetSelected extends AsyncTask<String,Void, String> {
    ...
    public SetSelected(Context context, int userId, int gameId){
    ...
    protected String doInBackground(String... strings) {
        try{
            String link = DataBase.HOST+"setSelected.php";
    ...
    protected void onPostExecute(String result){
        if(result.equals("true")){
            toast.showToas(context,context.getString(R.string.added),true);
        }else {
